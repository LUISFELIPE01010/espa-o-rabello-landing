        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          animationDelay: "0.3s"
            ...
            <div className="relative">
              ...
              <img alt="Tratamento estético no Espaço Rabello" className="relative w-full max-h-[60vh] lg:max-h-[55vh] rounded-2xl shadow-xl object-cover aspect-square" loading="eager" src="/lovable-uploads/4a44cf0b-4ea1-4a81-97d5-ef0c7f0a0b19.png" />
            </div>
          </div>
        </div>
      </div>
